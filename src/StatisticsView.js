StatisticsModule.StatisticsView = (function() {
	...
	init = function() {
		...
		$("#monthlyStatsTab").on('click', onMonthlyStatsTabClick); 
		
		return that; 
	}, 

	onMonthlyStatsTabClick = function(event) {
	...
	onEnlargementButtonClick = function(event) {
		...
		var title = $(this).closest(".title").find(".enlargementModalTitle").text(); 
		$("#chartEnlargementModal").find(".modal-title").text(title);
	}, 
	...
	/*
 	changes the chart type to line chart or column chart
 	*/
